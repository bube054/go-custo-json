...
func RunJSONParserTests(t *testing.T, tests []ParserTest) {
	for _, test := range tests {
		t.Run(test.msg, func(t *testing.T) {
			...
			fmt.Println("expected type", test.expectedNode, reflect.TypeOf(test.expectedNode))
			fmt.Println("actual type", node, reflect.TypeOf(node))
			// fmt.Printf("expected type: %T\n", test.expectedNode, reflect.TypeOf(test.expectedNode))
			// fmt.Printf("actual type:   %T\n", node, reflect.TypeOf(node))
			// fmt.Printf("expected token type: %T\n", test.expectedNode.(Null).Token)
			// fmt.Printf("actual token type:   %T\n", node.(Null).Token)

			diff := cmp.Diff(node, test.expectedNode)
			fmt.Println(diff)
...
// 	var tests = []ParserTest{
// 		// parse false
// 		{msg: "Parse false", input: []byte(`false`), expectedNode: Boolean{Token: newTokenPtr(FALSE, NONE, []byte("false"), 1, 1, nil)}, expectedErr: nil},
// 		{msg: "Parse false, with surrounding whitespace", input: []byte(` false `), expectedNode: Boolean{Token: newTokenPtr(FALSE, NONE, []byte("false"), 1, 2, nil)}, expectedErr: nil},
// 		{msg: "Parse false, with post line comment", input: []byte(`false // line comment`), expectedNode: Boolean{Token: newTokenPtr(FALSE, NONE, []byte("false"), 1, 1, nil)}, expectedErr: nil, cfg: NewParserConfig(WithAllowLineComments(true))},
// 		{msg: "Parse false, with post block comment", input: []byte(`false /* comment */`), expectedNode: Boolean{Token: newTokenPtr(FALSE, NONE, []byte("false"), 1, 1, nil)}, expectedErr: nil, cfg: NewParserConfig(WithAllowBlockComments(true))},
...
// 		// parse true
// 		{msg: "Parse true", input: []byte(`true`), expectedNode: Boolean{Token: newTokenPtr(TRUE, NONE, []byte("true"), 1, 1, nil)}, expectedErr: nil},
// 		{msg: "Parse true, with surrounding whitespace", input: []byte(` true `), expectedNode: Boolean{Token: newTokenPtr(TRUE, NONE, []byte("true"), 1, 2, nil)}, expectedErr: nil},
// 		{msg: "Parse true, with post line comment", input: []byte(`true // line comment`), expectedNode: Boolean{Token: newTokenPtr(TRUE, NONE, []byte("true"), 1, 1, nil)}, expectedErr: nil, cfg: NewParserConfig(WithAllowLineComments(true))},
// 		{msg: "Parse true, with post block comment", input: []byte(`true /* comment  */`), expectedNode: Boolean{Token: newTokenPtr(TRUE, NONE, []byte("true"), 1, 1, nil)}, expectedErr: nil, cfg: NewParserConfig(WithAllowBlockComments(true))},
...
// 		// 	Properties: map[string]JSON{"key": String{Token: newTokenPtr(STRING, DOUBLE_QUOTED, []byte(`"value"`), 1, 9, nil)},},
// 		// }, expectedErr: nil},
